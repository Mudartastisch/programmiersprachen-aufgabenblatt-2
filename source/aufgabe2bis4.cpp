...
int main(int argc, char *argv[])
{
	...
	std::vector<unsigned int> rndvec;
	...
	std::set<unsigned int> insidelist (rndint.begin(),rndint.end());
	...
	std::map<unsigned int, unsigned int> overview;
